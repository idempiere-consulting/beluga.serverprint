...
// N
    ...
    {
		return (I_sbsp_printconfig)MTable.get(getCtx(), I_sbsp_printconfig.Table_Name)
    ...
    {
		return (I_sbsp_printer)MTable.get(getCtx(), I_sbsp_printer.Table_Name)

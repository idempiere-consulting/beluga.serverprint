...
public interface I_sbsp_attributename 
{
    ...
    /** TableName=sbsp_attributename */
    public static final String Table_Name = "sbsp_attributename";
    ...
    /** Column name PrinterAttributeName */
    public static final String COLUMNNAME_PrinterAttributeName = "PrinterAttributeName";

	/** Set Printer Attribute Name.
	  * Name of Attribute to command a printer
	  */
    ...
    /** Column name sbsp_attributename_UU */
    public static final String COLUMNNAME_sbsp_attributename_UU = "sbsp_attributename_UU";
